        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-[28px] border border-white/10 bg-[#121212]/95 shadow-2xl">
                <div class="border-b border-white/10 px-8 py-6 text-white">
                    ...
                    <h1 class="mt-3 text-3xl font-normal">Edit product</h1>
                    <p class="mt-2 text-sm text-gray-300">Update the catalogue entry, stock count, and product image without leaving the admin panel.</p>
                </div>
                    ...
                    <form id="admin-product-edit-form" method="POST"
                        ...
                        <div class="flex items-center justify-between gap-4 border-t border-white/10 pt-6">
                            ...
                            <button type="submit" form="admin-product-edit-form"
                                class="inline-flex min-h-[46px] items-center justify-center rounded-xl border border-cyan-500/40 bg-cyan-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-cyan-500">
                                Update product
                            </button>
                        </div>
                    </form>
